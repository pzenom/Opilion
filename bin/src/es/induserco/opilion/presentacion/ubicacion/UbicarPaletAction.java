...
org.apache.struts2.interceptor.ServletRequestAware, ModelDriven<Object>
{
	...
	public String execute() throws Exception{
		...
		//Primero comprobamos si se trata de un almac�n que tengamos definido (con plazo, zonas, etc)
		if (almacen == 1){
			setUrl("UbicacionBarcia?codigoEntrada=" + ubicacion.getRegistro() +
					"&idPalet=" + ubicacion.getIdPalet() + "&cantidad=" + ubicacion.getCantidad());
			return "redirect";
		}else{
			//Si no, lo tratamos como si fuera un veh�culo, aunque sea un almacen
			if (almacen > 0){
