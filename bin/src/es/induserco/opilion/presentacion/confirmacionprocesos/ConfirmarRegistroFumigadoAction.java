...
public class ConfirmarRegistroFumigadoAction extends ActionSupport implements
org.apache.struts2.interceptor.ServletRequestAware, ModelDriven<Object>{
	...
	public void setServletRequest(HttpServletRequest request) {
		System.out.println("Confirmacion Registro Fumigado Action...");
	...
	public String execute() throws Exception {		
		...
		request.getSession().setAttribute("fecharegistro",(new GestionFumigadoHelper()).getFechaRegistro());
