...
public class InseRECongAction extends ActionSupport implements
	org.apache.struts2.interceptor.ServletRequestAware, ModelDriven<Object>, SessionAware
{
	 ...
	 * 2. lista de RE de CONG seleccionados
	 * */
	...
	public void setServletRequest(HttpServletRequest request) {
		System.out.println("Insertar RE que entran al proceso...");
	...
	public String execute() throws Exception {
	    ...
	    new GestionDesgranadoHelper().addRegistroProceso(gprod, "Congelado");
	    //Agrega los RE seleccionados a la tabla temporal del Proceso
	    //new GestionRegistroIngredientesHelper().addComponentesEnvasado(listaprocsele,gprod.getOrden(),"M");	 
	    new GestionRegistroIngredientesHelper().addComponentesProceso(listaprocsele,
	    		gprod.getOrden(), "Congelado");	    
	    System.out.println("Agrega las mp a la tabla temporal ");
	    request.getSession().setAttribute("listadocong",
		...
		Vector<LineaProducto> materias =
			new GestionDesgranadoHelper().getInfoMateriasProceso(gprod.getOrden(), "Congelado");
		/*int contador = 0;
		long idAnterior = 0;
