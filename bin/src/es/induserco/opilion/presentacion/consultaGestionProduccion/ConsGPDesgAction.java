...
public class ConsGPDesgAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listadesgranados",
				(new GestionDesgranadoHelper()).getRegistroDesgranados(gprod.getOrden(),fechaConsulta,gprod.getIdProducto()));
