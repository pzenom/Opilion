...
public class ConsGPCribAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listacribados",
				(new GestionCribadoHelper()).getRegistroCribados(gprod.getOrden(),fechaConsulta,gprod.getIdProducto()));
