...
public class ConsGPFumiAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listafumigados",
				(new GestionFumigadoHelper()).getRegistroFumigados(gprod.getOrden(),
						fechaConsulta));
