...
public class CargaPedidoEditableAction extends ActionSupport implements org.apache.struts2.interceptor.ServletRequestAware {
	...
	public void setServletRequest(HttpServletRequest request) {
		System.out.println("Struts CargaPedidoEditableAction...");
		this.request = request;
	} 
	
 	public String execute() throws IOException {
		try {
			System.out.println("CargaPedidoEditableAction");
