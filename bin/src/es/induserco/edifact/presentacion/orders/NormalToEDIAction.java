...
public class NormalToEDIAction extends ActionSupport implements
org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object> {
	...
	public Object getModel() {
 	...
 	public String execute() throws IOException {
 		 ...
 		 * 
 		 * piaNumIn (numero art�culo interno del comprador)
 		 * priInf
 		 */
		try {
			...
			//A cada una de las lineas en "lineas", a�adirle su conjunto de localizaciones
			...
			pedido.setResponsable(us.getLogin());
