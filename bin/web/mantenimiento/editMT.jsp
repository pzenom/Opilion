...
<div class="container" id="container">
	...
	<div id="content_main" class="clearfix">
			...
			<div id="dashboard">
	<div class="section">
		<h3 class="ico_posts">Mantenimiento de Maquinaria</h3>
				...
				<fieldset>
					...
					<table width="100%" cellpadding="2" cellspacing="2" border="0">
						<tr>
							...
							<td nowrap="nowrap">
								<s:select key="idTipoMaquinas" cssStyle="width:180px;" label="%{getText('entry.producto')}" list="%{#session.listaTiposMaquinas}" listKey="idTipo" listValue="descripcion" headerKey="0" headerValue="--Maquina--" cssStyle="text-align:left;" onchange="seleccionarTipoMaquinas()"/>
						...
						<tr>
							<td class="label"><s:label name="Nombre" value="Nombre" cssStyle="text-align:right;"/></td>
							<td colspan="3">
								<s:textfield key="nombre" label="%{getText('registro.label.nombre')}"/>
							</td>
						</tr>
						<tr>
...
<script type="text/javascript" src="mantenimiento/editMT.js"></script>
</body>
</html>