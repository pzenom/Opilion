...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
				...
				$.ajax( {
					...
					"error": function (xhr, error, thrown) {
						if ( error == "parsererror" ) {
							$.msg( "DataTables warning: JSON data from server could not be parsed. "+
		 ...
		 * Purpose:  Update tale sizing based on contenido. This would most likely be used for scrolling
		...
		function _fnBuildSearchRow( oSettings, aData )
		{
			...
			if ( sSearch.indexOf('&') !== -1 )
			{
				...
				sSearch = nTmp.textcontenido ? nTmp.textcontenido : nTmp.innerText;
		 ...
		 * Returns:  string: - contenidos of the cookie - or null if no cookie with that name found
		...
		function _fnReadCookie ( sName )
		{
			var
				...
				sNameEQ = sName + '_' + aParts[aParts.length-1].replace(/[\/:]/g,"").toLowerCase() + '=',
			 	sCookiecontenidos = document.cookie.split(';');
			
			for( var i=0 ; i<sCookiecontenidos.length ; i++ )
			{
				var c = sCookiecontenidos[i];
