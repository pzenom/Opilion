...
<s:i18n name="ApplicationResources">
	<h3 class="handle">Consulta procesos de desgranado - CONS_GP_DESG</h3>
	<div id="divNecesarioWidget">
		<div id="consulta" style="display: none;">
			<s:form action="ConsGPDesg" id="listado" name="listado" validate="true">
				<fieldset><!-- Filtro Campos-->
					<label>Criterios de desgranado</label>
					<section class="sectionMitad">
						<label for="orden">Orden</label>
						<div>
							<input type="text" id="ordenDesgranado" name="orden" title="Orden">
		...
		<p>&nbsp;</p>
		<div id="demo">
			<table id="tablaDesgranados" cellpadding="0" cellspacing="0" border="0" class="display" style="display: none;">
				<thead>
					<tr>
				...
				<tbody>
					<s:iterator id="entidad" value="%{#session.listadesgranados}">
						<tr>
							<td><s:property value="orden" /></td>
							<td><s:property value="fecha" /></td>
							<td><s:property value="descProducto" /></td>
							<td><s:property value="destrio" /></td>
