...
<s:i18n name="ApplicationResources">
	...
	<div id="divNecesarioWidget">
		<s:iterator id="entrada" value="%{#session.listaregistrosupd}">
			<s:form name="formulario" action="InseREDesg" validate="true">
				<fieldset>
				...
				<fieldset>
						<label>Configuraci&oacute;n de la desgranado</label>
						...
						<div class="widget" id="widget_1">
							...
							<div id="breadcrumbcontent">
								<div>
									<h3>Cantidad</h3>
									<p>
										Introduzca la cantidad que se va a desgranar
										<fieldset>
											<section>
												<label for="cantidadDesgranadoar">Cantidad</label>
												<div>
													<s:textfield id="cantidadDesgranadoar" key="saldoregistro" />
												</div>
											</section>
										</fieldset>
								...
								<div>
									...
									<p>
										Desgranado la ubicaci&oacute;n de la que se va a sacar el registro de entrada
								...
								<div>
									...
									<p>
										...
										<table class="tabla" border="1">
											...
											<tbody>
												<s:iterator id="cates" value="%{#session.listacategoriasdesgranado}">
													<tr>
														<td><input id="<s:property value="idCategoria" />" class="check" type="checkbox" name="listCateDesg" value="<s:property value="idCategoria" />"/></td>
														<td><s:property value="nombreCategoria" /></td>
														<td>
															<s:textfield id="cantidad_%{#cates.idCategoria}" cssClass="cantidadDesgranadoada" name="cantidad" key="cantidad" size="10" value="0" />
														</td>
													</tr>
												</s:iterator>
											</tbody>
									...
									<!-- <section class="sectionMitad">
										<label for="cantidadDestrio">Cantidad destr&iacute;o</label>
										<div>
											<s:textfield id="cantidadDestrio" key="destrio" />
										</div>
									</section> -->
								</div>
							</div>
