...
<s:i18n name="ApplicationResources">
	...
	<div id="divNecesarioWidget">
		<s:form name="formulario" action="UpdaREFumiCant" validate="true" >
			<div id="demo">
				<table id="tablaFumi" cellpadding="0" cellspacing="0" border="0" class="display">
					<thead>
						<tr>
					...
					<tbody>
						<s:iterator id="ingre" value="%{#session.listadofumi}">
							<tr>
