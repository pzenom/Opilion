...
<s:i18n name="ApplicationResources">
	<h3 class="handle"><s:text name="Consulta procesos de fumigados" /><span class="screenCode">CONS_GP_FUMI</span></h3>
	<div id="divNecesarioWidget">
		<div id="consulta" style="display: none;">
			<s:form name="listado" action="ConsGPFumi" validate="true">
		...
		<div id="demo">
			<table id="tablaRegistros" cellpadding="0" cellspacing="0" border="0" class="display" style="display: none;">
				...
				<tbody>
					<s:iterator id="entidad" value="%{#session.listafumigados}">
						<tr>
							...
							<td style="text-align:center;">
								<a href="javascript:ubicarSalidaFumigado('<s:property value="orden" />');"><img src="img/package.png" alt="Ubicar" title="Ubicar" /></a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
