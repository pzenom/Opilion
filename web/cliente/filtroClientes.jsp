		...
		<tbody>
			<s:iterator id="entidad" value="%{#session.listaclientes}">
				<tr>
					...
					<td>
						<a href="javascript:cargarCliente(<s:property value="idUsuario" />);">
							<img src="img/edit.png" alt="Editar" title="Editar"/>
						</a>
					</td>
					<!-- <td>
						<a href="javascript:eliminarCliente(<s:property value="idUsuario" />);">
							<img src="img/cancel.jpg" alt="Deshabilitar" title="Deshabilitar"/>
						</a>
					</td> -->
					<td>
						<a href="javascript:gestionarCobrosCliente(<s:property value="idUsuario" />);">
							<img src="img/money.png" alt="Gestion de pagos/cobros" title="Gestion de pagos/cobros"/>
						</a>
					</td>
				</tr>
			</s:iterator>
