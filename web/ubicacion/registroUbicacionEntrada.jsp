...
<div class="container" id="container">
	...
	<div id="dashboard">
	<div class="section">
		<h3 class="ico_ubi">Ubicacion de Registro de Entrada</h3>
				<fieldset>
			...
			<fieldset>
				...
				<MAP NAME="mapa1">
					...
					<area shape=POLY border="1" coords="270,10, 440,10, 440,45,  270,45, 270,10" href="InseRUE.action?zona=1&codigoEntrada=<s:property value="codigoEntrada" />" onclick="return alert('Ubicado en: Congelacion 1 arriba');return window.close()" alt="Congelacion 1 arriba" title="Congelacion 1 arriba">
					<area shape=POLY border="1" coords="270,80, 440,80, 440,115, 270,115, 270,80" href="InseRUE.action?zona=1&codigoEntrada=<s:property value="codigoEntrada" />" onclick="return alert('Ubicado en: Congelacion 1 abajo');return window.close()" alt="Congelacion 1 abajo" title="Congelacion 1 abajo">
					<area shape=POLY border="1" coords="450,10, 620,10, 620,45, 450,45, 450,10" href="InseRUE.action?zona=2&codigoEntrada=<s:property value="codigoEntrada" />" onclick="return alert('Ubicado en: Congelacion 2 arriba');return window.close()" alt="Congelacion 2 arriba" title="Congelacion 2 arriba">
					<area shape=POLY border="1" coords="450,80, 620,80, 620,115, 450,115, 450,80" href="InseRUE.action?zona=2&codigoEntrada=<s:property value="codigoEntrada" />" onclick="return alert('Ubicado en: Congelacion 2 abajo');return window.close()" alt="Congelacion 2 abajo" title="Congelacion 2 abajo">
