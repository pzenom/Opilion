...
<body>
				...
				<div id="main_panel_container" class="left">
					<div id="dashboard">
						<div id="tabledata" class="section">
							<p class="idPantalla"><s:text name="envasadoAuto.codigoPantalla" /></p>
							<h3 class="ico_posts"><s:text name="envasado.titulo" /></h3>
							<div id="nuevoEnvasado">
								<!-- AQUI EL DIV DE AJAX -->
								<sx:div name="ajax" id="ajaxDiv" theme="ajax">
									...
									<s:form id="formulario" name="formulario" action="InsertaOrdenEnv" validate="true" method="get">
												...
												<div value="" class="contenedorProducto" id="contenedorProducto_<s:property value="codigoEan"/>" class="contenedorProducto">
													<table class="tabla" width="100%" cellpadding="2" cellspacing="2" border="0">
														...
														<tr>
															...
															<td>
																<s:textfield key="c" id="c" cssStyle="width:180px;" label="%{getText('envasado.unidades')}" cssStyle="text-align:right;" value="%{#session.cantidad}"/>
										...
										<s:submit id="envasarTodo" value="Envasar"/>
									</s:form>
								</sx:div>
							</div><!--nuevo envasado-->
						</div><!-- end #tabledata -->
	...
	<script type="text/javascript" src="gpenvasado/ordenEnvaAuto.js"></script>
</body>
</html>