...
<s:i18n name="ApplicationResources">
	<h3 class="handle">Lotes del envase<span class="screenCode">LOTES_ENVA</span></h3>
	<div id="divNecesarioWidget">
		<div id="lotesEnvase">
			<table id="tablaLotesEnvase" cellpadding="0" cellspacing="0" border="0" class="display" style="display: none;">
				<thead>
					<tr>
