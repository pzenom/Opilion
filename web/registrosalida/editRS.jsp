...
<div class="container" id="container">
	...
	<div id="content_main" class="clearfix">
			...
			<div id="dashboard">
				<h3 class="ico_mug">Actualizar Registro Salida: <s:property value="codigoSalida" /></h3>
				 <!-- Parámetros de consulta-->
				 <s:form action="UpdaRS" validate="true" onsubmit="javascript:window.opener.location.reload();javascript:window.close();">
				<!-- Detalle de c/registro a actualizar -->
					<fieldset>
							<s:iterator id="salida" value="%{#session.listarsupd}">
