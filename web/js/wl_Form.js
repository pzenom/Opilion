	...
	reset: function () {
		...
		_inputs.each(function () {
			...
			if (_type == "checkbox") {
				...
				_this.val(_this.data('wl_initdata')).wysiwyg("setcontenido", _this.data('wl_initdata'));
	...
	submit: function () {
		...
		_inputs.each(function (i, e) {
			...
			if (_el.data('wl_Date')) {
				...
				//copy the contenido to the textarea
				_el.wysiwyg('save');
				_data[key] = _el.val();
				...
				$this.find("input,textarea,select,div.date,div.slider").each(function () {
					...
					if (values[tag_name] != null) {
						...
						if (_type == "checkbox") {
							...
							_this.data('wl_initdata', values[tag_name]).val(values[tag_name]).wysiwyg("setcontenido", values[tag_name]);
