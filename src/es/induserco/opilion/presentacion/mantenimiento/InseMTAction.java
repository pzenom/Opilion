 ...
 * @version 1.0
 */
public class InseMTAction extends ActionSupport implements
	org.apache.struts2.interceptor.ServletRequestAware, ModelDriven
{
	...
	public String execute() throws Exception {
		...
		if ((entry.getIdMaquina() == null) || (entry.getIdMaquina() == 0))
			new GestionRegistroEntradaHelper().addMT(entry);
		else
			new GestionRegistroEntradaHelper().addMTProgramado(entry);
		return "redirect";
	}
}