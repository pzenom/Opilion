...
/**
 * The Class FiltGPCongAction.
 */
public class FiltGPCongAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listaproductos",(new GestionCongeladoHelper()).getProductos());
