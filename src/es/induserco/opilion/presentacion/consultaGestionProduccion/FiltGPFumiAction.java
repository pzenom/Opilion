...
/**
 * The Class FiltGPFumiAction.
 */
public class FiltGPFumiAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listaproductos",(new GestionFumigadoHelper()).getProductos());
