...
/**
 * The Class FiltGPDesgAction.
 */
public class FiltGPDesgAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listaproductos",(new GestionDesgranadoHelper()).getProductos());
