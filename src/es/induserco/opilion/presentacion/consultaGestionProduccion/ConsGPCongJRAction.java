...
public class ConsGPCongJRAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		...
		consulta=new GestionCongeladoHelper().getRegistroCongelados(gprod.getOrden(),fechaConsulta,gprod.getIdProducto());
		...
		try {
            ...
            JasperCompileManager.compileReportToFile(
            		"C:\\reportes\\ConsGPCongJR.jrxml",
            		"C:\\reportes\\ConsGPCongJR.jasper");
        } catch (Exception e) {
            e.printStackTrace();
            return ERROR;
        }		
