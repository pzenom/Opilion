...
public class ConsREDesgAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>{
	...
	public String execute() throws Exception {
		if (gprod.getOrden() == null)
			gprod.setOrden("");
		request.getSession().setAttribute("listaregistrosdesgranado",
				(new GestionDesgranadoHelper()).getREProceso(gprod.getOrden(),gprod.getIdProducto(), 5));
	...
	//@Override
	public Object getModel() { System.out.println("Consulta RE para Proceso: Desgranado"); return gprod; }	
}