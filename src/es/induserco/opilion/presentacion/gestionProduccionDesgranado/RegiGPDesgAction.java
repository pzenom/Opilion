...
public class RegiGPDesgAction extends ActionSupport implements
	...
	public String execute() throws Exception {
		...
		request.getSession().setAttribute("listacategoriasdesgranado",
				(new GestionRegistroEntradaHelper()).getCategorias(entry.getCodigoEntrada()));
		/** SACAR UBICACIONES **/
		Vector<LineaProducto> materias = new GestionDesgranadoHelper().getInfoMateria(entry.getCodigoEntrada());
		ArrayList<Ubicacion> ubicaciones = new GestionUbicacionesHelper().getUbicacionesEntrada(entry.getCodigoEntrada(), true);
