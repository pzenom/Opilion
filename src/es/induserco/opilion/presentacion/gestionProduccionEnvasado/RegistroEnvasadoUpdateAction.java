...
/**
 * The Class RegistroEnvasadoUpdateAction.
 */
public class RegistroEnvasadoUpdateAction extends ActionSupport implements
	org.apache.struts2.interceptor.ServletRequestAware, ModelDriven
{
	...
	public void setServletRequest(HttpServletRequest request) {
		System.out.println("Registro Envasado Update Action...");
	...
	public String execute() throws Exception {
		...
		//request.getSession().setAttribute("listahoras",(new GestionEnvasadoHelper()).getHorasProceso());
		...
		//request.getSession().setAttribute("listaregistrosupd",(new GestionEnvasadoHelper()).getRegistroEnvasados(gprod.getOrden(),gprod.getFecha(),gprod.getLoteAsignado(),gprod.getIdProducto()));
