...
public class ConsProductosJRAction extends ActionSupport 
implements org.apache.struts2.interceptor.ServletRequestAware,ModelDriven<Object>
{
	...
	public String execute() throws Exception {
		consulta = new GestionProductosHelper().getProductos(null, false);
		try {
            JasperCompileManager.compileReportToFile(
            		"C:\\reportes\\ConsProductosJR.jrxml",
            		"C:\\reportes\\ConsProductosJR.jasper");
        } catch (Exception e) {
            e.printStackTrace();
            return ERROR;
        }			
