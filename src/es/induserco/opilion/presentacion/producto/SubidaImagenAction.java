...
public class SubidaImagenAction extends ActionSupport implements
org.apache.struts2.interceptor.ServletRequestAware {
	...
	public void setServletRequest(HttpServletRequest request) {
		System.out.println("Struts File Upload Action (SubidaImagenAction)...");
    ...
    public String execute() throws IOException {
		...
		File uploadDir = new File(sc.getRealPath("/img/productos/"));
