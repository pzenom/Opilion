...
public class InseDetaAlbaOrdenAction extends ActionSupport implements
	...
	public String execute() throws Exception {
		...
		//Llega un cero de más en: cantidadTotal, importeTotal, numeroBultosTotal, pesoNetoTotal
		...
		while(iterator.hasNext()) {
			...
			//1. Cargamos la información general del albarán
		...
		if (auto){
			...
			for (int i = 1; i <= cuantasLineas; i++){
				...
				//Leemos la información de la línea 
				int cuantosBultos = 0;
				...
				//3. Para cada uno de los bultos en la línea...
		...
		/**
		 * Todavía no se conocen, se modifican en el futuro: comercial y vehículo
		 * pesoNetoTotal
		 */
