...
public class IMD {
	...
	private String imdCara;	//DSC= descripción, 35=color, 98=talla 
	private String imdCodi;	//Descripción del artículo codificado CU=Unidad de consumo, DU=Unidad de envio
	private String imdDesc;	//Descripción del artículo
	...
	public IMD(Long idOrders, Long idLinea, String imdForm, String imdCara,
		...
		this.imdTipo = imdForm;  //F ó C
		this.imdCara = imdCara;  //DSC ó 35, 98...
